...
export function colorizeJson(text: string, theme: ColorTheme): React.ReactNode[] {
...
export default function CodeView({ text, mode, theme }: {
  ...
  return (
    <pre className="p-4 text-code font-mono font-normal whitespace-pre-wrap min-h-0">
      {colored}
    </pre>
  );
}
