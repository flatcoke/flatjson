...
export default function OutputPanel({
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="px-3 py-1.5 bg-surface border-b border-gray-200 flex items-center justify-between">
      ...
      <div className="flex-1 min-h-0 overflow-auto">
        {parsed.ok ? (
          outputTab === "tree" ? (
            ...
            largeFile ? (
              <pre className="p-4 text-code font-mono font-normal whitespace-pre-wrap text-gray-700 min-h-0">
